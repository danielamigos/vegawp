<?php /* Template Name: Review Page Template */ get_header(); ?>
					...
					<?php if (have_posts()): while (have_posts()) : the_post(); ?>
						<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <?php if( have_rows('review_sites') ): ?>
                                ...
                                <div class="row review-links-wrapper">
                                                        
                                <?php while( have_rows('review_sites') ): the_row(); $image = get_sub_field('image');  ?>
                                    <div class="col-sm-3 review-link">
                                        <a href="<?php the_sub_field('link');?>"><img src="<?php echo $image['url']; ?>" alt="<?php the_sub_field('name'); ?>"/></a></br>
